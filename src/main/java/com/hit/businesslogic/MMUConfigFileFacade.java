...
public class MMUConfigFileFacade implements Runnable{
	...
	private AuthenticationService AM = new AuthenticationService();
	private MMUConfigFileService fileBrowsing = new MMUConfigFileService();
	...
	public void run() {
		try{
			...
			boolean userAuthentication = AuthenticationService.authenticate(username, password);
